            ...
            <div id="article">
                ...
                <table border="1">
                    ...
                    <tr>
                        ...
                        <td class="board_contents2">${board.b_subject}</td>
                        <td class="board_contents3">${board.b_name}</td>
                        <td class="board_contents4">
                        	<fmt:formatDate pattern="yyyy-MM-dd" value="${board.b_wdate}" /></td>
                        <td class="board_contents5">
                        	<fmt:formatDate pattern="yyyy-MM-dd" value="${board.b_udate}" /></td>
                    </tr>
                   </c:forEach> 
                </table>
            </div>
